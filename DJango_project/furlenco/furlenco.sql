...
--
-- Host: localhost
-- Generation Time: May 09, 2020 at 08:35 AM
...
CREATE TABLE `billdetails` (
  ...
  `qty` int(11) NOT NULL,
  `renttype` varchar(400) DEFAULT NULL,
  `froms` varchar(200) DEFAULT NULL,
  `tos` varchar(200) DEFAULT NULL,
...
INSERT INTO `billdetails` (`bdid`, `title`, `price`, `qty`, `renttype`, `froms`, `tos`, `month`, `photo`, `billid`, `fid`) VALUES
(1, 'Bunk Bed', 19950, 7, 'perdayrent', '2020-05-01', '2020-05-20', '19', 'furniturephotos/39bunk2.jpg', 4, 10),
(2, 'Bunk Bed', 19950, 7, 'perdayrent', '2020-05-01', '2020-05-20', '19', 'furniturephotos/39bunk2.jpg', 5, 10);
...
CREATE TABLE `billing` (
  ...
  `paystatus` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `billing` (`billid`, `email`, `address`, `totalamount`, `mobile`, `status`, `typeofbill`, `dateoforder`, `paystatus`) VALUES
(1, 'nohumafok@mailinator.com', 'Id in expedita dolo', 19950, '6280995201', 'pending', 'Cash', '2020-05-09', 'pending'),
(2, 'nohumafok@mailinator.com', 'Id in expedita dolo', 19950, '6280995201', 'pending', 'Cash', '2020-05-09', 'pending'),
(3, 'nohumafok@mailinator.com', 'Id in expedita dolo', 19950, '6280995201', 'pending', 'Cash', '2020-05-09', 'pending'),
(4, 'nohumafok@mailinator.com', 'Id in expedita dolo', 19950, '6280995201', 'pending', 'Cash', '2020-05-09', 'pending'),
(5, 'nohumafok@mailinator.com', 'Id in expedita dolo', 19950, '6280995201', 'pending', 'Cash', '2020-05-09', 'pending');
...
('6280995201', 'Erica Buchanan', 'nohumafok@mailinator.com', 'Id in expedita dolo', 'Ut consectetur minu', 'Pa$$w0rd!', 'userpics/9507Visitors-at-Ubud-Palace-Bali-Indonesia-aerial-view.jpg', 1111111144, 1111111111, 'Vel ipsam ut ut sed '),
('7626912102', 'Callum Wade', 'harsh@gmail.com', 'Aspernatur aliqua M', 'Molestiae modi alias', '1234', 'userpics/8234Visitors-at-Ubud-Palace-Bali-Indonesia-aerial-view.jpg', 1234, 1234567, 'Ea aliquip rerum con'),
...
--
ALTER TABLE `billdetails`
  MODIFY `bdid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
