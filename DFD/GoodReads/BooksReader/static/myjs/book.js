    ...
    xml.onreadystatechange = function () {
        if (this.status == 200 && this.readyState == 4) {
            ...
            for (var i = 0; i < output.length; i++) {
                ...
                s += "<td><button type='button' class='btn text-warning' onclick='editbook(" + JSON.stringify(output[i]) + ")'><i class='fa fa-edit fa-2x'></i></button></td>";
                s += "<td><a href='samplebook?id=" + output[i]['id'] + "' class='btn text-primary'><i  class='fa fa-book-reader fa-2x'> </i></a></td>";
